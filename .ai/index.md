...
1. **CRITICAL REQUIREMENT**: Read `src/lib/constants/README.md`, `src/lib/utils/README.md`, and `src/components/ui/README.md` first before referencing or modifying constants, helper utilities, or shared UI components.
2. Read `context/architecture.md` to understand the project structure.
3. Review `context/coding-standards.md` for coding conventions.
4. Use appropriate prompts from `prompts/` folder for specific tasks.
5. Follow workflows from `workflows/` for complex multi-step tasks.
