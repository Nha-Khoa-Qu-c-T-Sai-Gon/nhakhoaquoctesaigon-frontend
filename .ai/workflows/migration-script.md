...
const client = new Client({
  host: process.env.DB_HOST || "194.127.192.146",
...
const content = JSON.stringify({
  hero: {
    ...
    images: [{ type: "strapi", path: "/uploads/image.jpg", alt: "Alt text" }],
  },
  features: {
    badge: "Features",
    title: "Features Title",
    items: [{ icon: "Award", title: "Feature 1", description: "Description" }],
  },
  cta: {
    badge: "Get Started",
    title: "CTA Title",
