...
> [!IMPORTANT]
>
> ## 🚨 Check Folder Docs First
>
> **Before using or editing any Constants, Utilities, or Common UI Components, any developer/AI agent MUST read:**
>
> - `src/lib/constants/README.md`
> - `src/lib/utils/README.md`
> - `src/components/ui/README.md`
>   Always check for existing patterns, fallback files, and JSDocs to prevent duplication and maintain uniformity.
