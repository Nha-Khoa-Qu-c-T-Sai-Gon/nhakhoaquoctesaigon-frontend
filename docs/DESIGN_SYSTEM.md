...
--color-primary-50: #f0f9ff /* Lightest - backgrounds */
  ...
  --color-primary-300: #7dd3fc /* Medium light */ --color-primary-400: #38bdf8
  /* Medium */ --color-primary-500: #3bafda /* Main primary - buttons, links */
  --color-primary-600: #0284c7 /* Dark - hover states */
  --color-primary-700: #0369a1 /* Darker - active states */
  --color-primary-800: #075985 /* Very dark */ --color-primary-900: #0c4a6e
...
```css
--color-secondary-50: #f0fdfa /* Lightest */ --color-secondary-100: #ccfbf1
  /* Very light */ --color-secondary-200: #99f6e4 /* Light */
  --color-secondary-300: #5eead4 /* Main accent */
  --color-secondary-400: #2dd4bf /* Medium */ --color-secondary-500: #14b8a6
  /* Darker */ --color-secondary-600: #0d9488 /* Dark */
  --color-secondary-700: #0f766e /* Very dark */ --color-secondary-800: #115e59
  /* Darkest */ --color-secondary-900: #134e4a /* Ultra dark */;
```
...
--color-neutral-50: #fafafa /* Lightest - main background */
  ...
  --color-neutral-700: #404040 /* Darker */ --color-neutral-800: #262626
  /* Very dark */ --color-neutral-900: #171717 /* Darkest - headings */;
```
...
```css
--color-destructive-500: #ef4444 --color-destructive-600: #dc2626;
```
...
--radius-sm: 0.375rem /* 6px - small elements */ --radius-md: 0.5rem
  /* 8px - inputs, buttons */ --radius-lg: 0.75rem /* 12px - cards */
  --radius-xl: 1rem /* 16px - large cards */ --radius-2xl: 1.5rem
  /* 24px - modals */ --radius-full: 9999px /* Fully rounded */;
```
...
```tsx
<Textarea placeholder="Tell us about your concerns..." />
```
